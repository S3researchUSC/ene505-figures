...
# AREA PLOT -------------
  ...
  area_elec_netgen_1973_2017 = f.areaplot(dt, xval, yval, fillval, 
  ...
  ggsave(area_elec_netgen_1973_2017, 
...
# LINE PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "1973 - 2017 U.S. Monthly Net Electricity Generation By Source"
  sublab = "Data: EIA Annual Energy Review"
  gval = "Y"
  xlab = NULL
  ylab = "Kilowatt-hour (Billions)"
  ...
  line_elec_netgen_1973_2017 = f.lineplot(dt, xval, yval, fillval, 
                                          tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
    scale_x_date(date_breaks = "5 years", date_labels = "%Y", expand = c(0,1)) +
    scale_y_continuous(breaks = seq(0,200,20), expand = c(0,0), limits = c(0, 200))
  
  ggsave(line_elec_netgen_1973_2017, 

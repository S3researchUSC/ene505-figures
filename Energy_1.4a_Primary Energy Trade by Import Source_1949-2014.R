...
# ---------------------------------------------------------------
  ...
  # AREA PLOT -------------
    ...
    yval = dt[, Value]
    fillval = dt[, MSN]
    tlab = "1949 - 2015 U.S. Primary Energy Trade by Import Source"
    ...
    area_energy_import_1949_2014 = f.areaplot(dt, xval, yval, fillval, tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
    ...
    ggsave(area_energy_import_1949_2014, 
           filename = "Energy_1.4a_Primary Energy Trade by Import Source 1949-2014_ATS.png", 
           width = 14.5, 
           height = 8.16, 
           dpi = 400)
  ...
  # LINE PLOT -------------
    ...
    line_energy_import_1949_2014 = f.lineplot(dt, xval, yval, fillval, tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
      scale_x_continuous(breaks = seq(1945,2015,10), expand = c(0,0)) +
      scale_y_continuous(breaks = seq(0,25,5), expand = c(0,0), limits = c(0, 25))
    
    ggsave(line_energy_import_1949_2014, 
           filename = "Energy_1.4a_Primary Energy Trade by Import Source 1949-2014_LTS.png", 
           width = 14.5, 
           height = 8.16, 
           dpi = 400)
  ...
  # SEGMENT PLOT -------------
    ...
    ggsave(seg_energy_import_1949_2014, 
           filename = "Energy_1.4a_Primary Energy Trade by Import Source 1949-2014_STS.png", 
           width = 14.5, 
           height = 8.16, 
           dpi = 400)

# Petroleum_Production by Shale Region_2007-2015 #
...
data.file     = c('Petroleum_Oil Production by Region_2007_2015.csv') # data file to be used
...
# ---------------------------------------------------------------
  ...
  yval = dt[, value]/1000
  fillval = dt[, region]
  tlab = "2007 - 2014 Daily U.S. Oil Production by Shale Region"
  sublab = "Data: U.S Energy Information Administration"
  gval = "Y"
  xlab = NULL
  ylab = "Thousand BBL/Day"
  leglab = NULL
  ...
  area_ng_prod_shale_region = f.areaplot(dt, xval, yval, fillval, 
    ...
    scale_x_date(breaks = seq(as.Date("2006-01-01"), as.Date("2015-01-01"), by = "2 years"), 
                 limits = c(as.Date("2007-01-01"), as.Date("2015-01-01")),
                 date_labels = "%b %Y", 
                 expand = c(0,0)) +
    scale_y_comma(breaks = seq(0,6000,1000), expand = c(0,0))
  
  ggsave(area_ng_prod_shale_region, 
         filename = "Petroleum_Natural Gas Production by Shale Region_2007-2014_ATS.png", 
         width = 11.1, 
         height = 6.25, 
         dpi = 400)
  ...
  line_ng_prod_shale_region = f.lineplot(dt, xval, yval, fillval, 
    ...
    scale_x_date(breaks = seq(as.Date("2006-01-01"), as.Date("2015-01-01"), by = "2 years"), 
                 ...
                 date_labels = "%b %Y", 
                 expand = c(0,0)) +
    scale_y_comma(breaks = seq(0,2000,500), limits = c(0,2000), expand = c(0,0))
  
  ggsave(line_ng_prod_shale_region, 
         filename = "Petroleum_Natural Gas Production by Shale Region_2007-2014_LTS.png", 
         width = 11.1, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(seg_ng_prod_shale_region, 
         filename = "Petroleum_Natural Gas Production by Shale Region_2007-2014_STS.png", 
         width = 11.1, 
         height = 6.25, 
         dpi = 400)

...
# load data ------
  ...
  dt_month = as.data.table(read.xlsx(data.file, sheet = "Monthly Data", startRow = 11, cols = c(1:2,4,6,8,10,12), detectDates = T))
  dt_month = dt_month[2:nrow(dt_month)]
  
  dt_annual = as.data.table(read.xlsx(data.file, sheet = "Annual Data", startRow = 11, cols = c(1:2,4,6,8,10,12), detectDates = T))
...
# ANNUAL AREA PLOT AND LINE PLOT -------------
  ...
  ggsave(area_annual, 
         filename = "Energy_Primary Energy Consumption by Sector_Annual_1949-2017_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_annual_2, 
         filename = "Energy_Primary Energy Consumption by Sector_Annual_1949-2017_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# MONTHLY AREA PLOT AND LINE PLOT -------------
  ...
  ggsave(area_month, 
         filename = "Energy_Primary Energy Consumption by Sector_Monthly_Jan1973-Apr2018_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_month_2, 
         filename = "Energy_Primary Energy Consumption by Sector_Monthly_Jan1973-Apr2018_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# LATEST YEAR BAR PLOT -------------
  ...
  ggsave(bar_annual, 
         filename = "Energy_Primary Energy Consumption by Sector_Annual_2017_BP.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)

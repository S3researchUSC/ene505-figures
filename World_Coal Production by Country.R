...
data.fil      = 'International_Coal Production by Country_1980-2016.csv' 
...
# read in data -------
  ...
  proddat = fread(data.fil, skip = 4, nrows = 233, header = FALSE, drop = c(1,3), col.names = c("Country",  c(1980:2016)))
...
# melt data table from wide to long format -----
  ...
  proddat = melt(proddat, measure.vars = colnames(proddat)[2:38],
...
setwd(out.loc) 
  ...
  fillval = dt[, Country]
  tlab = "Annual Coal Production by Country (1980 - 2016)"
  sublab = "Countries with 10 Highest Coal Production in 2015 \nData: U.S. Energy Information Administration"
  gval = "Y"
  xlab = NULL
  ylab = "Billion Short Tons"
  leglab = ""
  leg.ord = levels(factor(fillval))
  plot.cols = cntry.cols
  
  area_prod = ggplot(dt, aes(x = xval, y = yval, fill = fillval)) + 
    ...
    scale_x_continuous(breaks = seq(1980,2016,5), expand = c(0,0), limits = c(1980,2016)) +
  ...
  ggsave(area_prod, 
         filename = "World_Coal Production by Country_Most_Annual_1980-2016_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  
  line_prod = ggplot(dt, aes(x = xval, y = yval, color = fillval)) + 
  ...
  line_prod_2 <- ggplotGrob(line_prod)
  line_prod_2$layout$clip[line_prod_2$layout$name == "panel"] <- "off"
  # grid.draw(gt1)
  
  
  ggsave(line_prod_2, 
         filename = "World_Coal Production by Country_Most_Annual_1980-2016_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(area_prod, 
         filename = "World_Coal Production by Country_GDP_Annual_1980-2016_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_prod_2, 
         filename = "World_Coal Production by Country_GDP_Annual_1980-2016_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)

...
data.file     = 'Table_1.4b_Primary_Energy_Exports_by_Source_and_Total_Net_Imports.xlsx' # data file to be used
...
# melt data table from wide to long format -----
  ...
  dt_month = melt(dt_month, measure.vars = colnames(dt_month)[2:11],
                  variable.name = "MSN", value.name = "Value")
  
  dt_annual = melt(dt_annual, measure.vars = colnames(dt_annual)[2:11],
                   variable.name = "MSN", value.name = "Value")
  
# rename MSN factor levels -------
  
  dt_month[, MSN := revalue(MSN, c('Biomass.Exports' = "Biomass",
                                   'Coal.Exports' = "Coal",
                                   'Coal.Coke.Exports' = "Coal Coke",
                                   'Natural.Gas.Exports' = "Natural Gas",
                                   'Crude.Oil.Exports' = "Crude Oil",
                                   "Petroleum.Products,.Excluding.Biofuels,.Exports" = "Petroleum Products",
                                   "Total.Petroleum,.Excluding.Biofuels,.Exports" = "Total Petroleum", 
                                   'Electricity.Exports' = "Electricity",
                                   'Total.Energy.Exports' = "Total Primary Energy",
                                   'Total.Energy.Net.Imports' = 'Total Energy Net Imports'))]
  
  dt_annual[, MSN := revalue(MSN, c('Biomass.Exports' = "Biomass",
                                    'Coal.Exports' = "Coal",
                                    'Coal.Coke.Exports' = "Coal Coke",
                                    'Natural.Gas.Exports' = "Natural Gas",
                                    'Crude.Oil.Exports' = "Crude Oil",
...
# ANNUAL AREA PLOT AND LINE PLOT -------------
  ...
  dt = dt_annual[! MSN %in% c("Total Petroleum",
                              ...
                              "Total Energy Net Imports")][, MSN := factor(MSN, levels = c("Biomass",
                                                                                           "Electricity",
                                                                                           "Natural Gas",
                                                                                           "Petroleum Products",
                                                                                           "Crude Oil",
  ...
  yval = dt[, Value]
  fillval = dt[, MSN]
  tlab = "Annual U.S. Primary Energy Exports by Source (1949 - 2017)"
  ...
  ggsave(area_annual, 
         filename = "Energy_Primary Energy Exports by Source_Annual_1949-2017_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_annual_2, 
         filename = "Energy_Primary Energy Exports by Source_Annual_1949-2017_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# MONTHLY AREA PLOT AND LINE PLOT -------------
  ...
  yval = dt[, Value]
  fillval = dt[, MSN]
  tlab = "Monthly U.S. Primary Energy Exports By Source (January 1973 - April 2018)"
  sublab = "Data: EIA Annual Energy Review"
  gval = "Y"
  xlab = NULL
  ylab = "Quadrillion BTU"
  ...
  ggsave(area_month, 
         filename = "Energy_Primary Energy Exports by Source_Monthly_Jan1973-Apr2018_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_month_2, 
         filename = "Energy_Primary Energy Exports by Source_Monthly_Jan1973-Apr2018_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# LATEST YEAR BAR PLOT -------------
  ...
  yval = dt[, Value]
  fillval = dt[, MSN]
  tlab = "2017 U.S. Primary Energy Exports by Source"
  sublab = "Data: EIA Annual Energy Review"
  gval = "X"
  xlab = NULL
  ylab = "Quadrillion BTU"
  ...
  ggsave(bar_annual, 
         filename = "Energy_Primary Energy Exports by Source_Annual_2017_BP.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# (TOTALS ONLY) ANNUAL LINE PLOT -------------
  ...
  dt = dt_annual[ MSN %in% c("Total Petroleum", "Total Primary Energy", "Total Energy Net Imports")][, MSN := factor(MSN, levels = c("Total Petroleum", "Total Energy Net Imports",  "Total Primary Energy"))]
  xval = dt[, Year]
  yval = dt[, Value]
  fillval = dt[, MSN]
  tlab = "Annual U.S. Primary Energy Exports by Source (1949 - 2017)"
  ...
  ggsave(line_annual_2, 
         filename = "Energy_Primary Energy Exports by Source_Annual_1949-2017_Totals Only_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# (TOTALS ONLY) MONTHLY LINE PLOT -------------
  ...
  dt = dt_month[ MSN %in% c("Total Petroleum", "Total Primary Energy", "Total Energy Net Imports")][, MSN := factor(MSN, levels = c("Total Petroleum", "Total Energy Net Imports",  "Total Primary Energy"))]
  xval = dt[, Month]
  yval = dt[, Value]
  fillval = dt[, MSN]
  tlab = "Monthly U.S. Primary Energy Exports By Source (January 1973 - April 2018)"
  ...
  ggsave(line_month_2, 
         filename = "Energy_Primary Energy Exports by Source_Monthly_Jan1973-Apr2018_Totals Only_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)

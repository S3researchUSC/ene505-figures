# Energy_1.3_Primary Energy Consumption Estimates by Source 1949-2014 #
...
data.file     = 'Energy_1.3_Primary Energy Consumption by Source_1949_2012.csv' # data file to be used
...
# rename MSN factor levels -------
  dt_annual[, MSN := revalue(MSN, c(BMTCBUS = "Biomass",
                                    CLTCBUS = "Coal",
                                    FFTCBUS = "Total Fossil Fuels",
                                    GETCBUS = "Geothermal",
                                    HVTCBUS = "Hydroelectric",
                                    NNTCBUS = "Natural Gas",
                                    NUETBUS = "Nuclear",
                                    PMTCBUS = "Petroleum",
                                    RETCBUS = "Total Renewable Energy",
                                    SOTCBUS = "Solar PV",
                                    TETCBUS = "Total Primary Energy",
                                    WYTCBUS = "Wind"))]

...
setwd(out.loc) 
  ...
  # AREA PLOT -------------
    ...
    fillval = dt[, MSN]
    tlab = "1949 - 2014 Annual U.S. Electricity Generation By Source (Renewables Only)"
    ...
    area_elec_netgen_RE_1949_2014 = f.areaplot(dt, xval, yval, fillval, 
  ...
  # LINE PLOT -------------
    ...
    line_elec_netgen_RE_1949_2014 = f.lineplot(dt, xval, yval, fillval, 
                                               tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
      scale_x_continuous(breaks = seq(1948,2014,10), expand = c(0,0)) +
  ...
  # SEGMENT PLOT -------------
    ...
    seg_elec_netgen_RE_1949_2014 = f.segplot(dt, xval, yval, fillval, wsize, csize, 
                                             tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
      scale_x_continuous(breaks = seq(1948,2014,10), expand = c(0,0)) +
      scale_y_continuous(breaks = seq(0,0.4,0.1), expand = c(0,0), limits = c(0, 0.4))

...
# remove non-renewables and pumped storage ------
  dt_annual = dt_annual[ ! MSN %in% c("Coal", "Petroleum", "Natural Gas", "Nuclear", "Other Gases", "Hydroelectric Pumped Storage") ]
...
setwd(out.loc) 
  ...
  # AREA PLOT -------------
    ...
    area_elec_netgen_RE_1949_2014 = f.areaplot(dt, xval, yval, fillval, tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
    ...
    ggsave(area_elec_netgen_RE_1949_2014, 
  ...
  # LINE PLOT -------------
    ...
    line_elec_netgen_RE_1949_2014 = f.lineplot(dt, xval, yval, fillval, tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
      scale_x_continuous(breaks = seq(1948,2014,10), expand = c(0,0)) +
      scale_y_continuous(breaks = seq(0,0.4,0.1), expand = c(0,0), limits = c(0, 0.4))
    
    ggsave(line_elec_netgen_RE_1949_2014, 
  ...
  # SEGMENT PLOT -------------
    ...
    seg_elec_netgen_RE_1949_2014 = f.segplot(dt, xval, yval, fillval, wsize, csize, tlab, sublab, xlab, ylab, leglab, gval, leg.ord, plot.cols) + 
      scale_x_continuous(breaks = seq(1948,2014,10), expand = c(0,0)) +
      scale_y_continuous(breaks = seq(0,0.4,0.1), expand = c(0,0), limits = c(0, 0.4))
    
    ggsave(seg_elec_netgen_RE_1949_2014, 
           filename = "Electricity_8.2a_Electricity Net Gen Total RE Only_STS.png", 
           width = 14.5, 
           height = 8.16, 
           dpi = 400)

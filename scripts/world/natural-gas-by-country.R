...
# ------------------------------------ figures ------------------------------------
  ...
  # line, production -----
    ...
    labs_line_prod = ng_agg[type == 'production' & year == 2019]
    setorder(labs_line_prod, 'value')
    labs_line_prod[, position := value]
    labs_line_prod[1:3, position := c(1200,2700,4500)]
    
    line_prod = ggplot(ng_agg[type == 'production'], aes(x = year, y = value, color = label)) + 
      geom_line(size = 0.9) +
      labs(title = 'Annual dry natural gas production by country (1980-2019)',
           subtitle = 'Billion cubic feet', 
           caption = 'Top 5 natural gas producing countries in 2019 shown individually. All other countries aggregated. Data: U.S. Energy Information Administration', 
           x = NULL,
           y = NULL) +
      guides(color = 'none') +
      scale_x_continuous(breaks = seq(1980,2019,5), limits = c(1980,2019), expand = c(0,0)) +
      scale_y_continuous(labels = scales::comma, expand = c(0,0), breaks = seq(0,40000,5000), limits = c(0,35000)) +
    ...
    ggsave(line_prod, 
           filename = here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_lts.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_lts.pdf'))
    
    
    
  # area, production (absolute) -----
    
    labs_area_prod = ng_agg[type == 'production' & year == 2019][order(factor(label, levels = rev(c('All Other Countries', rev(top5_prod)))))]
    ...
    ggsave(area_prod, 
           filename = here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_ats_absolute.pdf'))
    
    
  # area, production (proportion) -----
    
    labs_area_prod_prop = ng_agg[type == 'production' & year == 2019][order(factor(label, levels = rev(c('All Other Countries', rev(top5_prod)))))]
    ...
    ggsave(area_prod_prop, 
           filename = here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-production-by-country_annual_1980-2019_ats_proportion.pdf'))
    
  # line, consumption -----
    
    labs_line_cons = ng_agg[type == 'consumption' & year == 2019]
    setorder(labs_line_cons, 'value')
    labs_line_cons[, position := value]
    labs_line_cons[1:4, position := seq(425, 4500, length.out = 4)]
    
    line_cons = ggplot(ng_agg[type == 'consumption'], aes(x = year, y = value, color = label)) + 
      geom_line(size = 0.9) +
      labs(title = 'Annual dry natural gas consumption by country (1980-2019)',
           subtitle = 'Billion cubic feet', 
           caption = 'Top 5 natural gas consuming countries in 2019 shown individually. All other countries aggregated. Data: U.S. Energy Information Administration', 
           x = NULL,
           y = NULL) +
      guides(color = 'none') +
      scale_x_continuous(breaks = seq(1980,2019,5), limits = c(1980,2019), expand = c(0,0)) +
      scale_y_continuous(expand = c(0,0), breaks = seq(0,30e3,5e3), labels = scales::comma) +
    ...
    ggsave(line_cons, 
           filename = here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_lts.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_lts.pdf'))
    
  # area, consumption (absolute) -----
    
    labs_area_cons = ng_agg[type == 'consumption' & year == 2019][order(factor(label, levels = rev(c('All Other Countries', rev(top5_cons)))))]
    ...
    area_cons = ggplot(ng_agg[type == 'consumption'], 
      ...
      labs(title = 'Annual dry natural gas consumption by country (1980-2019)',
           ...
           y = NULL) +
      scale_x_continuous(breaks = seq(1980,2019,5), limits = c(1980,2019), expand = c(0,0)) +
      scale_y_continuous(expand = c(0,0), breaks = seq(0,50e3,5e3), labels = scales::comma) +
      guides(fill = 'none',
             color = 'none') +
      scale_color_manual(values = pal_cons) + 
    ...
    ggsave(area_cons, 
           filename = here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_ats_absolute.pdf'))
    
    
  # area, consumption (proportion) -----
    
    labs_area_cons_prop = ng_agg[type == 'consumption' & year == 2019][order(factor(label, levels = rev(c('All Other Countries', rev(top5_cons)))))]
    ...
    labs_area_cons_prop[6, position := 0.998]
    ...
    ggsave(area_cons_prop, 
           filename = here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-consumption-by-country_annual_1980-2019_ats_proportion.pdf'))
    
    
    
  # line, imports -----
    
    labs_line_imp = ng_agg[type == 'imports' & year == 2019]
    setorder(labs_line_imp, 'value')
    labs_line_imp[, position := value]
    labs_line_imp[2:3, position := c(1900,2100)]
    
    line_imp = ggplot(ng_agg[type == 'imports'], aes(x = year, y = value, color = label)) + 
      geom_line(size = 0.9) +
      labs(title = 'Annual dry natural gas imports by country (1980-2019)',
           subtitle = 'Billion cubic feet', 
           caption = 'Top 5 dry natural gas importing countries in 2019 shown individually. All other countries aggregated. Data: U.S. Energy Information Administration', 
           x = NULL,
           y = NULL) +
      guides(color = 'none') +
      scale_x_continuous(breaks = seq(1980,2019,5), limits = c(1980,2019), expand = c(0,0)) +
      scale_y_continuous(expand = c(0,0), breaks = seq(0,6e3,5e2), labels = scales::comma) +
    ...
    ggsave(line_imp, 
           filename = here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_lts.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_lts.pdf'))
    
  # area, imports (absolute) -----
    
    labs_area_imp = ng_agg[type == 'imports' & year == 2019][order(factor(label, levels = rev(c('All Other Countries', rev(top5_imp)))))]
    ...
    area_imp = ggplot(ng_agg[type == 'imports'], 
      ...
      labs(title = 'Annual dry natural gas imports by country (1980-2019)',
           ...
           y = NULL) +
      scale_x_continuous(breaks = seq(1980,2019,5), limits = c(1980,2019), expand = c(0,0)) +
      scale_y_continuous(expand = c(0,0), breaks = seq(0,16e3,3e3), labels = scales::comma) +
      guides(fill = 'none',
             color = 'none') +
      scale_color_manual(values = pal_imp) + 
    ...
    ggsave(area_imp, 
           filename = here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_ats_absolute.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_ats_absolute.pdf'))
    
    
  # area, imports (proportion) -----
    
    labs_area_imp_prop = ng_agg[type == 'imports' & year == 2019][order(factor(label, levels = rev(c('All Other Countries', rev(top5_imp)))))]
    ...
    ggsave(area_imp_prop, 
           filename = here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_ats_proportion.pdf'),
                outfile = here::here('figures', 'world', 'natural-gas-imports-by-country_annual_1980-2016_ats_proportion.pdf'))

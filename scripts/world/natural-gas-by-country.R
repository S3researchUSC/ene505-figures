...
# label all non-top 5 countries as "Other" (for exports, just top 2) -----
  ...
  ng_ranked[! type == 'exports', label := ifelse(rank %in% 1:5, country, 'All Other Countries')]
  ng_ranked[type == 'exports', label := ifelse(rank %in% 1:2, country, 'All Other Countries')]

...
data.fil      = 'International_Natural Gas Production by Country_1980-2015.csv' 
...
# read in data -------
  ...
  proddat = fread(data.fil, skip = 4, nrows = 233, header = FALSE, drop = c(1,3), col.names = c("Country",  c(1980:2015)))
...
# melt data table from wide to long format -----
  ...
  proddat = melt(proddat, measure.vars = colnames(proddat)[2:37],
...
# ---------------------------------------------------------------
  ...
  yval = dt[, Value]
  fillval = dt[, Country]
  tlab = "Annual Natural Gas Production by Country (1980 - 2015)"
  sublab = "Countries with 10 Highest Natural Gas Production in 2015 \nData: U.S. Energy Information Administration"
  gval = "Y"
  xlab = NULL
  ...
  ggsave(area_prod, 
         filename = "World_Natural Gas Production by Country_Most_Annual_1980-2015_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_prod_2, 
         filename = "World_Natural Gas Production by Country_Most_Annual_1980-2015_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(area_prod, 
         filename = "World_Natural Gas Production by Country_GDP_Annual_1980-2015_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_prod_2, 
         filename = "World_Natural Gas Production by Country_GDP_Annual_1980-2015_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)

...
#  ------------------------------------------------------- FIGURES -------------------------------------------------------
  ...
  # line, monthly -------
    ...
    fig_line_month = ggplot(dt_month, aes(x = month, y = value/1000, group = sector, color = sector)) + 
      geom_line(size = 0.6) +
      labs(title = 'Monthly U.S. primary energy consumption by sector (Jan 1973-May 2020)',
           subtitle = 'Quadrillion BTU', 
           caption = 'Data: U.S. Energy Information Administration',
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_month, 
           filename = here::here('figures', 'energy', 'primary-energy-consumption-by-sector_month_Jan1973-May2020_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-consumption-by-sector_month_Jan1973-May2020_lts.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-consumption-by-sector_month_Jan1973-May2020_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_month, 
    #        filename = here::here('figures', 'energy', 'primary-energy-consumption-by-sector_month_Jan1973-May2020_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)

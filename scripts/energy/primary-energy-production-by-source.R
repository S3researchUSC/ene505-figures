...
data.file     = 'Table_1.2_Primary_Energy_Production_by_Source.xlsx' 
...
# rename columns ----
  ...
  colnames(dt_annual) = c('year', 'Coal', 'Natural Gas (Dry)', 'Crude Oil', 'Natural Gas (Liquid)', 'Total Fossil Fuels', 'Nuclear', 
                          'Hydroelectric', 'Geothermal', 'Solar', 'Wind', 'Biomass', 'Total Renewables', 'Total Primary Energy')
  
  colnames(dt_month) = c('month', 'Coal', 'Natural Gas (Dry)', 'Crude Oil', 'Natural Gas (Liquid)', 'Total Fossil Fuels', 'Nuclear', 
                         'Hydroelectric', 'Geothermal', 'Solar', 'Wind', 'Biomass', 'Total Renewables', 'Total Primary Energy')
...
#  ------------------------------------------------------- FIGURES -------------------------------------------------------
  ...
  # bar, 2019 ---------
    ...
    fig_bar_2019 = ggplot(dt_annual[year == max(year)], 
      ...
      labs(title = 'Annual U.S. primary energy production by source (2019)',
           subtitle = NULL, 
    ...
    ggsave(fig_bar_2019, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_2019_bar.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_2019_bar.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_2019_bar.pdf'))
  ...
  # line, annual -------
    ...
    labs_line[ , position := value]
    labs_line[ fuel2 == 'Nuclear' , position := position - 0.45 ]
    labs_line[ fuel2 == 'Other Renewables' , position := position + 0.7 ]
    
    fig_line_annual = ggplot(dt_annual_agg, aes(x = year, y = value, group = fuel2, color = fuel2)) + 
      geom_line(size = 0.9) +
      labs(title = 'Annual U.S. primary energy production by source (1949-2019)',
    ...
    ggsave(fig_line_annual, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_lts.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_annual, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual (absolute) -------
    ...
    ggsave(fig_area_annual_abs, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_absolute.pdf'))
    
    # save as png: 
    # ggsave(fig_area_annual_abs, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_absolute.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual (proportion) -------
    ...
    fig_area_annual_prop = ggplot(dt_annual_agg, aes(x = year, y = prop, group = fuel2, fill = fuel2)) + 
      geom_area() +
      labs(title = 'Annual U.S. primary energy production by source (1949-2019)',
           subtitle = 'Share of total primary energy production', 
           caption = 'Data: U.S. Energy Information Administration',
           x = NULL,
           y = NULL,
           fill = NULL) +
    ...
    ggsave(fig_area_annual_prop, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_annual_1949-2019_ats_proportion.pdf'))
  ...
  # line, annual, renewables -------
    ...
    fig_line_annual_re = ggplot(dt_annual_re, aes(x = year, y = value, group = fuel, color = fuel)) + 
      geom_line(size = 0.9) +
      labs(title = 'Annual U.S. primary energy production from renewable sources (1949-2019)',
           subtitle = 'Quadrillion BTU', 
           caption = 'Data: U.S. Energy Information Administration',
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_annual_re, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_lts.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_annual, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual, renewables (absolute) -------
    ...
    ggsave(fig_area_annual_abs_re, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_absolute.pdf'))
    
    # save as png: 
    # ggsave(fig_area_annual_abs, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_absolute.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual, renewables (proportion) -------
    ...
    fig_area_annual_prop_re = ggplot(dt_annual_re, aes(x = year, y = prop, group = fuel, fill = fuel)) + 
      geom_area() +
      labs(title = 'Annual U.S. primary energy production from renewable sources (1949-2019)',
           subtitle = 'Share of renewable primary energy production', 
           caption = 'Data: U.S. Energy Information Administration',
           x = NULL,
           y = NULL,
           fill = NULL) +
    ...
    ggsave(fig_area_annual_prop_re, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_annual_1949-2019_ats_proportion.pdf'))
  ...
  # line, annual, totals  -------
    ...
    ggsave(fig_line_annual_tot, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_lts.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_annual_tot, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual, totals (absolute) -------
    ...
    ggsave(fig_area_annual_abs_tot, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_ats_absolute.pdf'))
  ...
  # area, annual, totals (proportion) -------
    ...
    ggsave(fig_area_annual_prop_tot, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_totals_annual_1949-2019_ats_proportion.pdf'))
  ...
  # line, monthly ------
    ...
    fig_line_month = ggplot(dt_month_agg, aes(x = month, y = value, group = fuel2, color = fuel2)) + 
      geom_line(size = 0.5) +
      labs(title = 'Monthly U.S. primary energy production by source (Jan 1973-May 2020)',
           subtitle = 'Quadrillion BTU',
           caption = 'Data: U.S. Energy Information Administration',
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_month, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_month_Jan1973-May2020_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_month_Jan1973-May2020_lts.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_month_Jan1973-May2020_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_month, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_month_Jan1973-May2020_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # line, renewables, monthly -------
    ...
    fig_line_month_re = ggplot(dt_month_re, aes(x = month, y = value, group = fuel, color = fuel)) + 
      geom_line(size = 0.5) +
      labs(title = 'Monthly U.S. primary energy production from renewable sources (Jan 1973-May 2020)',
           subtitle = 'Quadrillion BTU', 
           caption = 'Data: U.S. Energy Information Administration',
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_month_re, 
           filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_month_Jan1973-May2020_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_month_Jan1973-May2020_lts.pdf'),
                outfile = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_month_Jan1973-May2020_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_month_re, 
    #        filename = here::here('figures', 'energy', 'primary-energy-production-by-source_renewables_month_Jan1973-May2020_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)

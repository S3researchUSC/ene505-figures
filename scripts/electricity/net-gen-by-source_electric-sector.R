...
#  ------------------------------------------------------- FIGURES -------------------------------------------------------
  ...
  # bar, 2019 ---------
    ...
    ggsave(fig_bar_2019, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_2019_bar.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_2019_bar.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_2019_bar.pdf'))
    
    # save as png: 
    # ggsave(fig_bar_2019,
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_2019_bar.png'),
    #        width = 11.5,
    #        height = 6.25,
    #        dpi = 600)
  ...
  # line, annual -------
    ...
    fig_line_annual = ggplot(dt_annual_agg, aes(x = year, y = value/1000, group = fuel, color = fuel)) + 
      ...
      scale_y_continuous(breaks = seq(0,2000,500), limits = c(0,2000), labels = scales::comma, expand = c(0,0)) +
      scale_color_manual(values = pal_fuel) + 
      theme_line +
    ...
    ggsave(fig_line_annual, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts.pdf'))
    ...
    fig_line_annual_2 = ggplot(dt_annual, aes(x = year, y = value/1000, group = MSN, color = MSN)) + 
      ...
      guides(color ='none') +
      scale_x_continuous(breaks = seq(1949,2019,5), limits = c(1949, 2019), expand = c(0,0)) +
      scale_y_continuous(labels = scales::comma, breaks = seq(0,2000,500), limits = c(0,2000), expand = c(0,0)) +
      scale_color_manual(values = pal_fuel) +
      theme_line +
    ...
    ggsave(fig_line_annual_2, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts_v2.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts_v2.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts_v2.pdf'))
    
    # save as png:
    # ggsave(fig_line_annual, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual (absolute) -------
    ...
    ggsave(fig_area_annual_abs, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_absolute.pdf'))
    
    # save as png: 
    # ggsave(fig_area_annual_abs, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_absolute.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # area, annual (percentage) -------
    ...
    ggsave(fig_area_annual_prop, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_proportion.pdf'))
    
    # save as png:
    # ggsave(fig_area_annual_prop, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_annual_1949-2019_ats_proportion.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # renewable, line, annual -------
    ...
    labs_line_re[1:3, position := c(0,15,30)]
    ...
    fig_line_annual_re = ggplot(dt_annual_re, aes(x = year, y = value/1000, group = MSN, color = MSN)) + 
      geom_line(size = 0.9) +
      labs(title = 'U.S. electricity generation from renewable sources, electric power sector (1949-2019)',
           subtitle = 'Billion Kilowatthours',
           caption = 'Data: U.S. Energy Information Administration', 
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_annual_re, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_lts.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_annual_re, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # renewable, area, annual (absolute) -------
    ...
    labs_area_re[ MSN == 'Geothermal', position := position - 12 ]
    labs_area_re[ MSN == 'Waste', position := position + 2 ]
    labs_area_re[ MSN == 'Wood', position := position + 10 ]
    ...
    fig_area_annual_abs_re = ggplot(dt_annual_re, aes(x = year, y = value/1000, group = MSN, fill = MSN)) + 
      ...
      guides(fill = 'none',
             color ='none') +
      geom_text(data = labs_area_re, aes(x = Inf, y = position, label = paste0(' ', MSN), color = MSN), hjust = 0, size = 6.5, fontface = 'plain', family = 'Secca Soft') +
      theme_area_labeled
    ...
    ggsave(fig_area_annual_abs_re, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_absolute.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_absolute.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_absolute.pdf'))
    
    # save as png: 
    # ggsave(fig_area_annual_abs_re,
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_absolute.png'),
    #        width = 11.5,
    #        height = 6.25,
    #        dpi = 600)
  ...
  # renewable, area, annual (proportion) -------
    ...
    labs_area_re_prop[ MSN == 'Geothermal', position := position - 0.02 ]
    labs_area_re_prop[ MSN == 'Waste', position := position  ]
    ...
    fig_area_annual_prop_re = ggplot(dt_annual_re, aes(x = year, y = prop, group = MSN, fill = MSN)) + 
      ...
      guides(fill = 'none',
             color ='none') +
      theme_area_labeled + 
      geom_text(data = labs_area_re_prop, aes(x = Inf, y = position, label = paste0(' ', MSN), color = MSN), hjust = 0,  size = 6.5, fontface = 'plain', family = 'Secca Soft')  
    ...
    ggsave(fig_area_annual_prop_re, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_proportion.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_proportion.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_proportion.pdf'))
    
    # save as png: 
    # ggsave(fig_area_annual_prop_re,
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_annual_1949-2019_ats_proportion.png'),
    #        width = 11.5,
    #        height = 6.25,
    #        dpi = 600)
  ...
  # line, monthly (not labeled) -------
    ...
    fig_line_month = ggplot(dt_month_agg, aes(x = month, y = value/1000, group = fuel, color = fuel)) + 
      geom_line(size = 0.5) +
      labs(title = 'Monthly U.S. electricity generation by energy source, electric power sector (Jan 1973-May 2020)',
           subtitle = 'Billion Kilowatthours',
           caption = 'Data: U.S. Energy Information Administration', 
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_month, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_month, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # line, monthly (labeled) -------
    ...
    ggsave(fig_line_month_lab, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts_labeled.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts_labeled.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts_labeled.pdf'))
    
    # save as png:
    # ggsave(fig_line_month, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_month_Jan1973-May2020_lts_labeled.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
  ...
  # renewable, line, monthly -------
    ...
    fig_line_month_re = ggplot(dt_month_re, aes(x = month, y = value/1000, group = MSN, color = MSN)) + 
      geom_line(size = 0.5) +
      labs(title = 'Monthly U.S. electricity generation from renewable sources, electric sector (Jan 1973-May 2020)',
           subtitle = 'Billion Kilowatthours',
           caption = 'Data: U.S. Energy Information Administration', 
           x = NULL,
           y = NULL) +
    ...
    ggsave(fig_line_month_re, 
           filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_month_Jan1973-May2020_lts.pdf'), 
           width = 11.5, 
           height = 6.25)
    
    embed_fonts(here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_month_Jan1973-May2020_lts.pdf'),
                outfile = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_month_Jan1973-May2020_lts.pdf'))
    
    # save as png:
    # ggsave(fig_line_month_re, 
    #        filename = here::here('figures', 'electricity', 'net-generation-by-source_electric-sector_renewables_month_Jan1973-May2020_lts.png'), 
    #        width = 11.5, 
    #        height = 6.25, 
    #        dpi = 600)
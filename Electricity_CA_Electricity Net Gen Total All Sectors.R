# Electricity_CA_Electricity Net Gen Total All Sectors_Script #
...
# remove small and large hydroelectric -----
  dt_new = dt_raw[ ! MSN %in% c("Small Hydroelectric", "Large Hydroelectric")]
...
# melt data table from wide to long format -----
  dt_long = melt(dt_wide, measure.vars = colnames(dt_wide)[1:13],

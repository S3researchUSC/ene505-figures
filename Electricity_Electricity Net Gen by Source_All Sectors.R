...
data.file     = 'Table_7.2a_Electricity_Net_Generation__Total_(All_Sectors).xlsx' # data file to be used
...
# ANNUAL AREA PLOT AND LINE PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "Annual U.S. Electricity Generation of All Sectors By Source (1949 - 2017)"
  ...
  ggsave(area_annual, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Annual_1949-2017_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_annual_2, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Annual_1949-2017_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# MONTHLY AREA PLOT AND LINE PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "Monthly U.S. Electricity Generation of All Sectors By Source (January 1973 - April 2018)"
  sublab = "Data: U.S. Energy Information Administration"
  gval = "Y"
  xlab = NULL
  ylab = "Kilowatt-hour (Billions)"
  ...
  ggsave(area_month, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Monthly_Jan1973-Apr2018_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_month_2, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Monthly_Jan1973-Apr2018_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# LATEST YEAR BAR PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "2017 U.S. Electricity Generation of All Sectors By Source"
  sublab = "Data: U.S. Energy Information Administration"
  gval = "X"
  xlab = NULL
  ylab = "Kilowatt-hour (Billions)"
  ...
  ggsave(bar_annual, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Annual_2017_BP.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# (RE ONLY) ANNUAL AREA PLOT AND LINE PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "Annual U.S. Renewable Electricity Generation of All Sectors By Source (1949 - 2017)"
  sublab = "Data: U.S. Energy Information Administration"
  gval = "Y"
  xlab = NULL
  ylab = "Kilowatt-hour (Billions)"
  ...
  ggsave(area_annual, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Annual_1949-2017_RE_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_annual_2, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Annual_1949-2017_RE_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# (RE ONLY) MONTHLY AREA PLOT AND LINE PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "Monthly U.S. Renewable Electricity Generation of All Sectors By Source (January 1973 - April 2018)"
  sublab = "Data: U.S. Energy Information Administration"
  gval = "Y"
  xlab = NULL
  ylab = "Kilowatt-hour (Billions)"
  ...
  ggsave(area_month, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Monthly_Jan1973-Apr2018_RE_ATS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
  ...
  ggsave(line_month_2, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Monthly_Jan1973-Apr2018_RE_LTS.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
...
# (RE ONLY) LATEST YEAR BAR PLOT -------------
  ...
  yval = dt[, Value]/1000
  fillval = dt[, MSN]
  tlab = "2017 U.S. Renewable Electricity Generation of All Sectors By Source"
  sublab = "Data: U.S. Energy Information Administration"
  gval = "X"
  xlab = NULL
  ylab = "Kilowatt-hour (Billions)"
  ...
  ggsave(bar_annual, 
         filename = "Electricity_Net Electricity Gen by Source_All Sectors_Annual_2017_RE_BP.png", 
         width = 11.75, 
         height = 6.25, 
         dpi = 400)
